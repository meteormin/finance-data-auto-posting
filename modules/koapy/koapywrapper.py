...
class KoapyWrapper:
    ...
    def getCodeListByMarketAsList(self,marketCode: str) -> dict:
    ...
    def getStockBasicInfoAsDict(self,code: str)-> dict:
    ...
    def getStockInfoBySectorAsList(self,sector: str, marketCode = '0')->list:
